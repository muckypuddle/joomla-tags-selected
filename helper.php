...
abstract class ModTagsselectedHelper
{
	public static function getContentList($params)
	{
		...
		$query= $tagsHelper->getTagItemsQuery($tagsToMatch, $contentTypes, $includeChildren, $orderByOption = 'c.core_title', $orderDir = 'ASC',$anyOrAll = true, $languageFilter = 'all', $stateFilter = '0,1');
